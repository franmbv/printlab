...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.code === 200) {
      ...
      setStatus({ succes: false, message: 'Ocurrió un error, por favor intente de nuevo.'});
    }
  };
              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="Nro. Telefono" onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
